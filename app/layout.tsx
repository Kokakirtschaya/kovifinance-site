...
export const metadata: Metadata = {
  ...
  description:
    "Помогаем бизнесу получить кредиты, банковские гарантии, факторинг и лизинг. Знаем требования банков и по опыту сделок понимаем, куда подавать заявку. Заявка — 5 минут, предварительное решение — от 3 дней.",
  keywords: [
    "кредит для бизнеса",
    "банковская гарантия",
    "факторинг",
  ...
  openGraph: {
    ...
    description:
      "Кредиты, гарантии, факторинг и лизинг для бизнеса. Знаем, в какой банк идти с вашей сделкой. Предварительное решение — от 3 дней.",
  },
