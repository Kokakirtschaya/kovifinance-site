...
function PrivacyNotice() {
  return (
    <div className="mt-5 text-[11px] leading-relaxed text-muted">
      <p>
        Оператор — {CONTACTS.legalName}, ИНН {CONTACTS.inn}, ОГРНИП {CONTACTS.ogrnip}. E-mail
        нужен только для отправки ссылки для входа, узнавания вас в кабинете и показа статуса
        ваших заявок. Рекламных писем без отдельного согласия не отправляем.
      </p>
      <p className="mt-2">
        Согласие на обработку даётся отметкой в поле выше. Подробности — в{" "}
        <Link
