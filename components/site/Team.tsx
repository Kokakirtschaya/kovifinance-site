    ...
    <section id="team" className="relative overflow-hidden py-20 md:py-28">
      ...
      <div className="relative mx-auto max-w-6xl px-5">
        ...
        {/* Карточку НЕ оборачиваем в Reveal: пока у предка анимируется opacity,
            ...
            Подложка плотная (ink/25), чтобы вид не зависел от поддержки фильтра. */}
        <div className="mt-12">
          <div className="grid overflow-hidden rounded-3xl border border-white/15 bg-ink/25 shadow-[var(--shadow-lift)] backdrop-blur-md md:grid-cols-[0.85fr_1.15fr]">
