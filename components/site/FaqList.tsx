...
/** Общий аккордеон FAQ: заголовок и подвал одинаковые, отличаются только вопросы.
    Вынесен, чтобы не держать копию разметки на каждой посадочной странице. */
export default function FaqList({
  ...
  // null — свёрнуты все: список читается целиком, посетитель раскрывает нужное сам
